            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All Superviser/adviser are listed here..</h5>
                    ...
                    @foreach($admins as $admin)
                        ...
                        <tr class="gradeX">
                            ...
                            <td>
                                ...
                                <a href="{{URL::to('adviser_request',$admin->id )}}">
                                    <small class="label label-primary"><i class="fa"></i>Request</small>
                                </a>
                                <a href="{{ route('adviser_delete',  $admin->id) }}">
