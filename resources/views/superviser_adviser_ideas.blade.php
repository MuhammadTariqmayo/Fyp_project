            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All Student are listed here..</h5>
                  ...
                  @foreach($admins as $admin)
                        ...
                        <tr class="gradeX">
                            ...
                            <td class="center">{{$admin->user_id}}</td>
                            <td class="center">{{$admin->title}}</td>
                            <td class="center">{{$admin->description}}</td>
                            <td>
                                <!-- <a href="{{route('student_accept',$admin->id)}}">
                                    <small class="label label-primary"><i class="fa"></i>Accept</small>
                                </a>
                                <a href="{{route('student_reject',$admin->id)}}">
                                    <small class="label label-danger"><i class="fa"></i>Rejact</small>
                                </a> -->
