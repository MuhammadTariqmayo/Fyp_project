        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{route('student_update', $admins->id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden" name="id" value="">
                                        <input type="text" class="form-control" name="description" value="{{$admins->description}}">
                                    </div>
